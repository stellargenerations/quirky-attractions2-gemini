...
function createMarker(attraction) {
    ...
    const popupContent = `
        <div class="popup-content">
            ...
            <a href="/attractions/${attraction.slug}/" class="learn-more-link" target="_blank">Read Article</a>
        </div>
    `;
    ...
    return `
        <div class="list-card" id="list-item-${attraction.slug}" data-slug="${attraction.slug}">
            ...
            <div class="card-content">
                ...
                <a href="/attractions/${attraction.slug}/" class="card-link">Read Article</a>
            </div>
        </div>
    `;
}

...
<article class="attraction-detail container">
  ...
  <figure class="attraction-image">
    <img src="https://upload.wikimedia.org/wikipedia/commons/2/2b/Lucy_the_Elephant_in_Margate_City%2C_NJ.jpg?v=1743964413067" alt="Lucy the Elephant in Margate City, NJ.jpg" loading="lazy">
  </figure>
  ...
  {% set articleContent = collections.attractionArticles | getArticleForSlug('lucy-the-elephant') %}
  {% if articleContent %}
